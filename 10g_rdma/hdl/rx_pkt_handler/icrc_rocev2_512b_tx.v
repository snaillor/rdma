// icrc_rocev2_512b_tx.v
// 描述            : TX 路径 512bit ICRC 计算模块，对发送数据流逐拍计算 CRC32
//                   输出 CRC 校验结果，支持包丢弃场景
module icrc_rocev2_512b_tx #(
  ...
  assign pkt_len        = (eth_type == ETH_TYPE_IPV4) ? (ipv4_total_len + 16'd10) : (ipv6_pyld_len + 16'd50);
